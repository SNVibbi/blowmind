                ...
                <ul className="flex flex-wrap gap-8  md:gap-16 lg:gap-10">
                    {interests.map((int, index) => (
                        <li
                            ...
                            className={`flex items-center p-4 rounded-lg cursor-pointer border-2 ${isClicked[index] ? 'border-blue-500' : 'border-transparent'} bg-gray-200 text-indigo-400 dark:bg-gray-800 transition-all duration-300 w-28 md:w-40 lg:w-40`}
                        >
                            <Image 
                                src={int.src} 
                                alt={int.value} 
